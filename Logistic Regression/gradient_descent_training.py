...
def gradient_descent_training(X_train, y_train, X_test, y_test, theta, alpha, iterations):
    ...
    for it in range(iterations):
        ...
        train_iteration_cost = compute_cost(X_train, y_train, theta)
        cost_vector_train = np.append(cost_vector_train, train_iteration_cost)
        test_iteration_cost = compute_cost(X_test, y_test, theta)
        cost_vector_test = np.append(cost_vector_test, test_iteration_cost)
        ########################################/
