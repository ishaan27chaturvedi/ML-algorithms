...
errors, nn, cost_train, cost_test, prediction1, prediction2, prediction3 = train(X_train_normalized, y_train, hidden_neurons, iterations, learning_rate, X_test_normalized, y_test, is_iris)
